...
func NewMockEventManager() *MockEventManager {
	return &MockEventManager{
		EventManager: events.EventManager{
			...
			SaddCommandRequestChan:      make(chan events.SaddCommandEvent, 10),
			SremCommandRequestChan:      make(chan events.SremCommandEvent, 10),
			SismemberCommandRequestChan: make(chan events.SismemberCommandEvent, 10),
			SinterCommandRequestChan:    make(chan events.SinterCommandEvent, 10),
			ScardCommandRequestChan:     make(chan events.ScardCommandEvent, 10),
